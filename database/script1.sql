...
create table etnia(
id_et int not null auto_increment primary key,
nombre varchar(40) not null
);

insert into etnia values("Mapuche");
insert into etnia values("Aymara");
insert into etnia values("Rapa Nui");
insert into etnia values("Atacameño");
insert into etnia values("Quechua");
insert into etnia values("Kolla");
insert into etnia values("Diaguita");
insert into etnia values("Kawésqar");
insert into etnia values("Yagán o Yámana");
...
insert into parentesco values("Hermano");
insert into parentesco values("Hermana");
insert into parentesco values("Tio");
insert into parentesco values("Tia");
